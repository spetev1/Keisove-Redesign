...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Toggled by the ./share script while the demo is exposed through a
    | Cloudflare tunnel. When true the application forces the https scheme on
    | every generated URL, because TLS is terminated at Cloudflare's edge and
    | the container only ever sees a plain http request.
    |
    */
